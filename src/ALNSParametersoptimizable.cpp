...
void ALNS_Parameters_optimizable::modifyTimeSegmentsIt()
{
	...
	timeSegmentsIt = lbTimeSegmentsIt + rand()% __max(ubTimeSegmentsIt-lbTimeSegmentsIt,static_cast<size_t>(1));
...
void ALNS_Parameters_optimizable::modifyNbItBeforReinit()
{
	...
	nbItBeforeReinit = lbNbItBeforReinit + rand()%__max(ubNbItBeforReinit-lbNbItBeforReinit,static_cast<size_t>(1));
...
void ALNS_Parameters_optimizable::modifySigma1()
{
	...
	sigma1 = lbSigma1 + rand()% __max(ubSigma1-lbSigma1,1);
...
void ALNS_Parameters_optimizable::modifySigma2()
{
	...
	sigma2 = lbSigma2 + rand()% __max(ubSigma2-lbSigma2,1);
...
void ALNS_Parameters_optimizable::modifySigma3()
{
	...
	sigma3 = lbSigma3 + rand()% __max(ubSigma3-lbSigma3,1);
...
void ALNS_Parameters_optimizable::modifyMinDestroy()
{
	...
	minDestroyPerc = lbMinDestroyPerc + rand()% __max(ubMinDestroyPerc-lbMinDestroyPerc,1);
...
void ALNS_Parameters_optimizable::modifyMaxDestroy()
{
	...
	maxDestroyPerc = lbMaxDestroyPerc + rand()% __max(ubMaxDestroyPerc-lbMaxDestroyPerc,1);
...
void ALNS_Parameters_optimizable::modifyReloadFrequency()
{
	...
	reloadFrequency = lbReloadFrequency + rand()% __max(ubReloadFrequency-lbReloadFrequency,static_cast<size_t>(1));
